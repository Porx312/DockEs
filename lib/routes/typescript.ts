  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Tipos comunes JS y TS", href: "/tipos-comunes-javascript-typescript" },
        { title: "Uniones discriminadas & never", href: "/uniones-discriminadas-never-typescript" },
        { title: "Funciones", href: "/mas-sobre-funciones-typescript" },
        { title: "Genéricos TS", href: "/genericos" },
        { title: "Manipulación de Tipos", href: "/manipulacion-de-tipos", items: [
        { title: "Genéricos y Varianza en TS", href: "/patrones-genericos" },
        { title: "Operador keyof", href: "/operador-keyof" },
        { title: "Operador typeof", href: "/operador-typeof" },
        { title: "Tipos de acceso indexado", href: "/tipo-de-acceso-indexado" },
