    ...
    <div className="flex flex-col gap-8 items-center justify-center py-16 px-4 md:px-6 text-center max-w-5xl mx-auto">
      <div className="max-w-2xl text-center">
        ...
        <p className="text-lg dark:text-gray-200 text-gray-700">
          ...
          Accede a toda la documentación técnica completamente en español,
          organizada y siempre actualizada. Disfruta de características
          exclusivas pensadas para desarrolladores que valoran la claridad, la
          eficiencia y tener todo en un solo lugar.
        </p>
      </div>
